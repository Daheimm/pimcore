...
class ProductNomClass31C extends ProductNomClass3
{
    ...
    public function __construct($raw, ProductNomClass3 $n1)
    {
        $this->n1 = $n1;
        $this->raw = $raw;
    }

    public function from1C(): ProductNomClass3
    {

        $this->n1->setParentId($_ENV['PRODUCT_NOM_3']);
