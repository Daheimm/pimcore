...
class ProductNomClass21C extends ProductNomClass2
{
    ...
    public function __construct($raw, ProductNomClass2 $n1)
    {
        $this->n1 = $n1;
        $this->raw = $raw;
    }

    public function from1C(): ProductNomClass2
    {

        $this->n1->setParentId($_ENV['PRODUCT_NOM_2']);
