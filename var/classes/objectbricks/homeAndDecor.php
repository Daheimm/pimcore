 ...
 * - height [numeric]
 * - bladelength [numeric]
 * - knifediameter [numeric]
 * - length [numeric]
 * - diameter [numeric]
 * - power [numeric]
 * - width [numeric]
 * - basediameter [numeric]
 * - sharpening [numeric]
 * - capacity [numeric]
 ...
 * - burningtime [input]
 * - pagecount [numeric]
 * - colorrelation [manyToManyObjectRelation]
 * - sizerelation [manyToManyObjectRelation]
 * - materialrelation [manyToManyObjectRelation]
 */
...
return \Pimcore\Model\DataObject\Objectbrick\Definition::__set_state(array(
   ...
   'title' => 'Дім та декор - Кастомні атрибути',
   'group' => 'Дім та декор',
   'layoutDefinitions' => 
